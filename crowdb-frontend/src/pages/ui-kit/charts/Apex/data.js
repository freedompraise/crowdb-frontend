...
const columnWithLabelChartOpts = {
	chart: {
		height: 380,
		type: 'bar',
		toolbar: {
...
const multipleRadialbarChartOpts = {
	chart: {
		height: 350,
		type: 'radialBar',
	},
